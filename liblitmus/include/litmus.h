 ...
 */
int litmus_open_lock(obj_type_t protocol, int lock_id, const char* name_space, void *config_param);
...
/*	per-task modes */
enum rt_task_mode_t {
	BACKGROUND_TASK = 0, LITMUS_RT_TASK = 1
};
/**
